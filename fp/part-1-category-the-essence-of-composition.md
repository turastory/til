...
Morphisms can be composed, and the composition is associative.
...
So we separate the problems and solve each of them, and then combine those solutions to get the solutions of more larger problems

Eventually we get the solution of the original problem.

So this is the essence of programming - Decomposition & Composition. And it is also how our brain works too.
...
-> So we need right chunks for the composition of programs.

What are the "right chunks"?

-> Once we have implemented a program, forget about the details, and focus on the behavior - the interface, or the surface, of the program.
